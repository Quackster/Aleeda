...
namespace Aleeda.Net.Messages
{
    public class ServerMessage
    {
        ...
        private uint fID;
        /// <summary>
        ///The MemoryStream creates streams that have memory as a backing store instead of a disk or a network connection.
        /// </summary>
        ...
        public string Header
        {
            get
            {
                return AleedaEnvironment.GetDefaultEncoding().GetString(Base64Encoding.Encodeuint(ID, 2));
            }
        }
        /// <summary>
        ...
        #region Constructors
        /// <summary>
        /// Constructs a weak OutgoingMessage, which is not useable until Initialize() is called.
        /// </summary>
        ...
        /// <summary>
        /// Constructs a OutgoingMessage object with a given ID and no content.
        /// </summary>
        ...
        {
            return AleedaEnvironment.GetDefaultEncoding().GetString(Body.ToArray());
        }
        ...
        public void Append(byte[] bzData)
        {
            if (bzData != null && bzData.Length > 0)
                this.Body.Write(bzData, 0, bzData.Length);
        }
        /// <summary>
        ...
        {
            Append(s, AleedaEnvironment.GetDefaultEncoding());
        }
        /// <summary>
        ...
        public void Append(string s, Encoding Encoding)
        {
            ...
            {
                if (Encoding == null)
                    Encoding = AleedaEnvironment.GetDefaultEncoding();
        ...
        {
            if (b == true)
                Body.WriteByte(WireEncoding.POSITIVE);
            else
                Body.WriteByte(WireEncoding.NEGATIVE);
        }
        /// <summary>
        ...
        //        public void AppendRawInt32WithBreak(Int32 i, byte b)
        //        {
        //            AppendString(i.ToString(), b);
        //        }
        public void AppendRawInt32WithBreak(Int32 i, byte b)
        { 
            AppendString(i.ToString(), b);
        ...
        {
            byte[] Data = new byte[contentLength + 3];
            byte[] Header = Base64Encoding.Encodeuint(ID, 2);
...
//            get
//            {
//                return AleedaEnvironment.GetDefaultTextEncoding().GetString(Base64Encoding.Encodeuint(mID, 2));
//            }
//        }
//        /// <summary>
//        /// Gets the length of the content in this message.
...
//        public string GetContentString()
//        {
//            return AleedaEnvironment.GetDefaultTextEncoding().GetString(mContent.ToArray());
//        }
...
//            {
//                if (pEncoding == null)
//                    pEncoding = AleedaEnvironment.GetDefaultTextEncoding();
...
//            Append(WireEncoding.EncodeInt32(i));
//        }
//        public void AppendInt32(Int32 i, byte b)
//        {
//            Append(WireEncoding.EncodeInt32(i));
//            Append(b);
//        }
