...
namespace Aleeda.Scripting
{
    ...
    public class IonPluginHost : IIonPluginHost
    {
        ...
        public Type GetLimeEnvironmentType(string sTypeName)
        {
        ...
        public MethodInfo GetLimeEnvironmentMethod(Type pType, string sMethodName)
        {
    ...
    {
        #region Methods
        Type GetLimeEnvironmentType(string sType);
        MethodInfo GetLimeEnvironmentMethod(Type pType, string sMethodName);
        #endregion
    }
}
